...
?>
    ...
    $( "#upload_btn" ).on("click", function() {
        ...
        $.get( "/svar_rek/dbaddpost.php", { parent_id: values.parent_id, text_value : values.text_value  } );


        }).done(function(){
          $.ajax({
            type: 'post',
            url: '/svar_rek/posts?test=1.php',
            datatype: "json",
            complete: function(data){
              console.log(data);
              $("main").html("<h1>Frågor</h1>"+data.responseText);
            }
          });
        });
        */
